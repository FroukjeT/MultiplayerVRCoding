...
void GradientSkybox_SRP_Wrapper_float(in float3 colorT, in float3 colorM, in float3 colorB, in float exponentT, in float exponentB, in float intensity, in float3 dir, out float3 color) {
